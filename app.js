...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function(req, res) {
	...
	var args = req.body.args;
	var fcn1 = "addProduct";
	var fcn2 = "transferDtoC"
	var fcn3 = "serviceUpdate"
	var serialId = Math.random().toString(10).substr(2,7);
	var serviceId = Math.random().toString(10).substr(2,7);
	var insureId = Math.random().toString(10).substr(2,7);
	...
	logger.debug('args  : ' + args[7]);
	logger.debug('serialNo.  : ' + serialId);
